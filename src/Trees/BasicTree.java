...
public class BasicTree {
    ...
    public void levelOrderLinebyLine(Node1 root) {
        Queue<Node1> q = new LinkedList<Node1>();
        q.add(root);
        q.add(null);
        while (q.size() > 1) {
    ...
    public void levelOrderLinebyLine2(Node1 root) {
        Queue<Node1> q = new LinkedList<Node1>();
        q.add(root);
        while (!q.isEmpty()) {
            int count = q.size();
    ...
    public void printKdist(Node1 root, int k) {
        if (root == null) {
            return;
        }
        if (k == 0) {
    ...
    public void printSpiral(Node1 root) {
        if (root == null) {
            return;
        }
        Queue<Node1> q = new LinkedList<Node1>();
    ...
    boolean isChildrenSum(Node1 root) {
        if (root == null) {
            return true;
        }
    ...
    static void inorderIter(Node1 root) {
        if (root == null) {
            return;
        }
    ...
    static void pairSum(Node1 curr, int sum, Node1 root) {
        if (curr == null) {
            return;
        }
        int s = sum - curr.key;
    ...
    static Node1 find(Node1 root, int x) {
        if (root == null) {
            return null;
        }
        if (root.key == x) {
        ...
        Node1 left = find(root.left, x);
        if (left != null) {
            return left;
        }
        Node1 right = find(root.right, x);
        if (right != null) {
            return right;
        }
        return null;
    ...
    public static ArrayList<Integer> longestRootToLeafPath(Node1 root) {
        if (root == null) {
            return null;
        }
    ...
    public void binaryTreePaths(Node1 root) {
        if(root==null){
            return ;
        }
        System.out.print(""+root.key);
